double XSec(std::string fname){
	...
	else if(fname.find("HppM500") < fname.length()) return 1.717e-3;//Signal, H++ 500 GeV
	else if(fname.find("HppM600") < fname.length()) return 6.953e-4;//Signal, H++ 600 GeV
	else if(fname.find("HppM700") < fname.length()) return 3.051e-4;//Signal, H++ 700 GeV
	else if(fname.find("HppM800") < fname.length()) return 1.433e-4;//Signal, H++ 800 GeV
	else if(fname.find("HppM900") < fname.length()) return 6.976e-5;//Signal, H++ 900 GeV
	else if(fname.find("HppM1000") < fname.length()) return 3.519e-5;//Signal, H++ 1000 GeV
	else if(fname.find("HppM1100") < fname.length()) return 1.824e-5;//Signal, H++ 1100 GeV
	else if(fname.find("HppM1200") < fname.length()) return 9.636e-6;//Signal, H++ 1200 GeV
	else if(fname.find("HppM1300") < fname.length()) return 5.228e-6;//Signal, H++ 1300 GeV
	else if(fname.find("HppM1400") < fname.length()) return 2.857e-6;//Signal, H++ 1400 GeV
	else if(fname.find("HppM1500") < fname.length()) return 1.581e-6;//Signal, H++ 1500 GeV
...
double XSec_Uncert(std::string fname){//in %
	if(fname.find("HppM500") < fname.length()) return 0.000002732;//Signal, H++ 500 GeV
	else if(fname.find("HppM600") < fname.length()) return 0.000001099;//Signal, H++ 600 GeV
	else if(fname.find("HppM700") < fname.length()) return 4.80e-07;//Signal, H++ 700 GeV
	else if(fname.find("HppM800") < fname.length()) return 2.24e-07;//Signal, H++ 800 GeV
	else if(fname.find("HppM900") < fname.length()) return 1.09e-07;//Signal, H++ 900 GeV
	else if(fname.find("HppM1000") < fname.length()) return 5.45e-08;//Signal, H++ 1000 GeV
	else if(fname.find("HppM1100") < fname.length()) return 2.81e-08;//Signal, H++ 1100 GeV
	else if(fname.find("HppM1200") < fname.length()) return 1.48e-08;//Signal, H++ 1200 GeV
	else if(fname.find("HppM1300") < fname.length()) return 7.99e-09;//Signal, H++ 1300 GeV
	else if(fname.find("HppM1400") < fname.length()) return 4.35e-09;//Signal, H++ 1400 GeV
	else if(fname.find("HppM1500") < fname.length()) return 2.40e-09;//Signal, H++ 1500 GeV
